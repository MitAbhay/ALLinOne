        ...
        <div className="flex items-center justify-between border-y border-black bg-blue-500 py-10 lg:py-8">
          <div className="space-y-5 px-10 font-serif">
            ...
            <div className="text-sm">
              Here you can find each and every content, all the stuff one
              place.😊
            </div>
          </div>
          <img
            ...
            return (
              <Link key={post._id} href={`/Posts/${post.slug.current}`}>
                <div className="blog cursor-pointer">
                  <img
                    className="h-60 w-full cursor-pointer object-cover" // hover:scale-large transition-transform ease-in-out  duration-200
                    src={urlFor(post.mainImage).url()!}
                    alt="image"
                  />
                  <div className="bg-blue-400 p-2 shadow shadow-blue-500">
